...
# 读取男胎检测数据
data_path_female = '数据预处理/女胎检测数据_去离群值.csv'
data_path_male = '数据预处理/男胎检测数据_去离群值.csv'
...
plt.savefig(f'{output_dir}/箱型图_subplot组合_去离群值.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig(f'{output_dir}/小提琴图_subplot组合_去离群值.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout(pad=2.0)
plt.savefig(f'{output_dir}/性别对比_箱型图小提琴图合并_去离群值.png', dpi=300, bbox_inches='tight')
plt.close()
